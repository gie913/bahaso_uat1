...
$config['access_key'] = 'AKIAJ5N4QR5YMI5T2J2Q';
...
$config['secret_key'] = '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';
...
$config['bucket_name'] = 'assetdev.bahaso.info';
...
//$config['s3_url'] = 'http://assetdev.bahaso.info';
/*
|--------------------------------------------------------------------------
| Use Enviroment?
|--------------------------------------------------------------------------
